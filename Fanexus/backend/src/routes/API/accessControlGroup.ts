...
export const getAccessControlGroup: AuthRouteHandler = (req, res) =>
    sequelize
        ...
        .catch(error => {
            // console.log(error);
            console.log("accesscontrolgroup.ts.157")
            res.status(StatusCodes.BAD_REQUEST).send(
                ErrorReportService.getEnvError(
                    error,
...
export const updateAccessControlGroup: AuthRouteHandler = (req, res) =>
    sequelize
        ...
        .catch((error: any) => {
            // console.error(error);
            console.log('accesscontrolgroup.ts.224.error');
            res.status(StatusCodes.BAD_REQUEST).send(
                ErrorReportService.getEnvError(
                    error,
                    "accessControl_fetch_fail"
...
export const addAliasesToAccessControlGroup: AuthRouteHandler = (req, res) =>
    sequelize
        ...
        .catch(error => {
            // console.error(error);
            console.log('accesscontrolgroup.ts.258.error');
            return res
                .status(StatusCodes.BAD_REQUEST)
                .send(
                    ErrorReportService.getEnvError(
...
export const removeAliasesFromAccessControlGroup: AuthRouteHandler = (
    ...
    sequelize
        ...
        .catch((error: any) => {
            // console.log(error);
            console.log("accesscontrolgroup.ts.294")
            return res
                .status(StatusCodes.BAD_REQUEST)
                .send(
                    ErrorReportService.getEnvError(
...
export const addAccessControlGroupInclusion: AuthRouteHandler = (req, res) =>
    sequelize
        ...
        .catch((e: any) => {
            // console.log(e);
            console.log("accesscontrolgroup.ts.363")
...
export const removeAccessControlGroupInclusion: AuthRouteHandler = (req, res) =>
    sequelize
        ...
        .catch((e: any) => {
            // console.log(e);
            console.log("accesscontrolgroup.ts.410")
            res.send(e);
        });
