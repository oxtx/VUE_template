...
communityRouter.get(
    ...
    (req: AuthRequest, res): Promise<any> =>
        sequelize
            ...
            .catch((error: any) => {
                // console.error(error);
                console.log('error.community.125')
...
communityRouter.get(
    ...
    (req: AuthRequest, res): Promise<any> =>
        sequelize
            ...
            .catch((error: any) => {
                // console.error(error);
                console.log('error.community.231')
                res.status(error.status || StatusCodes.BAD_REQUEST).send(
                    ErrorReportService.getEnvError(
                        error.message || error,
                        "community_fetch_fail"
